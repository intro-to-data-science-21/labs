...
1. Disable the distinction between films that won an Oscar and those that did not. 
1. Creating an additional widget that lets you filter by country of origin of the film selection.
2. Allow for several countries to be selected simultaneously and display them with different colours.
