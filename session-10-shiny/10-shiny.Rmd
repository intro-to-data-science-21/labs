...
# Foreshadowing our last Lab `r emo::ji("ghost")`

Tomorrow's lecture will be on Ethics in the field of Data Science. This lecture will already be very interactive. It therefore makes little sense to cover ethics again in our lab next week. We though it would be better to organise that lab as a drop-in session, where you can come in with question regarding your final project. As promised, we will also have some materials on websites and how to create them with R and markdown, for those among you that are interested in building a personalised site. 
