...
As we saw in the lecture a structure like the following one would be a good starting point. 
...
For more in depth guides and explanations you can look [here](https://www.r-bloggers.com/2018/08/structuring-r-projects/). If you feel like you want to practice this you can find more material [here]("link here").
...
knitr::include_graphics("./github_desktop_cloning.gif")
```
...
```{r, echo=FALSE, out.width="85%", fig.cap="", fig.align="center"}
knitr::include_graphics("./github_desktop_stage_commit.gif")
```
...
```{r, echo=FALSE, out.width="85%", fig.cap="", fig.align="center"}
knitr::include_graphics("./github_desktop_pull_and_push.gif")
```
...
3. Switching branches can be accomplished through the dropdown menu next to it.
