...
![RStudio Interface](https://github.com/intro-to-data-science-21/labs/blob/main/session-1-intro/R-Studio.png)
...
**We will learn more about the assignment submission workflow next week. Still, avoid changing the name of the files you receive on Github since it will create issues.**
